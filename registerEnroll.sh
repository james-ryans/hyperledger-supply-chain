...
function enrollSupplier0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7055 --caname ca-supplier0 --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7055-ca-supplier0.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7055-ca-supplier0.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Registering peer"
  set -x
  fabric-ca-client register --caname ca-supplier0 --id.name peer --id.secret peerpw --id.type peer --id.attrs "role=supplier:ecert" --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/orderers/msp" --csr.hosts orderer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/peers/msp" --csr.hosts peer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/users/User@supplier0.com/msp" --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://supplier0admin:supplier0adminpw@localhost:7055 --caname ca-supplier0 -M "${PWD}/organizations/supplier0.com/users/Admin@supplier0.com/msp" --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7055 --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollProducer0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7056 --caname ca-producer0 --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7056-ca-producer0.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7056-ca-producer0.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Registering peer"
  set -x
  fabric-ca-client register --caname ca-producer0 --id.name peer --id.secret peerpw --id.type peer --id.attrs "role=producer:ecert" --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/orderers/msp" --csr.hosts orderer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/peers/msp" --csr.hosts peer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/users/User@producer0.com/msp" --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://producer0admin:producer0adminpw@localhost:7056 --caname ca-producer0 -M "${PWD}/organizations/producer0.com/users/Admin@producer0.com/msp" --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function enrollDistributor0() {
  ...
  infoln "Registering peer"
  set -x
  fabric-ca-client register --caname ca-distributor0 --id.name peer --id.secret peerpw --id.type peer --id.attrs "role=distributor:ecert" --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function enrollRetailer0() {
  ...
  infoln "Registering peer"
  set -x
  fabric-ca-client register --caname ca-retailer0 --id.name peer --id.secret peerpw --id.type peer --id.attrs "role=retailer:ecert" --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
