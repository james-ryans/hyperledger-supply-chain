...
function enrollSuperadmin() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca.superadmin.com --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7054-ca-superadmin-com.pem
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/orderers/msp" --csr.hosts orderer.superadmin.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.superadmin.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/peers/msp" --csr.hosts peer.superadmin.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/peers/tls" --enrollment.profile tls --csr.hosts peer.superadmin.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/users/User@superadmin.com/msp" --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://superadminadmin:superadminadminpw@localhost:7054 --caname ca.superadmin.com -M "${PWD}/organizations/superadmin.com/users/Admin@superadmin.com/msp" --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7054 --tls.certfiles "${PWD}/organizations/superadmin.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollSupplier0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7055 --caname ca.supplier0.com --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7055-ca-supplier0-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7055-ca-supplier0-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/orderers/msp" --csr.hosts orderer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/peers/msp" --csr.hosts peer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.supplier0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/users/User@supplier0.com/msp" --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://supplier0admin:supplier0adminpw@localhost:7055 --caname ca.supplier0.com -M "${PWD}/organizations/supplier0.com/users/Admin@supplier0.com/msp" --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7055 --tls.certfiles "${PWD}/organizations/supplier0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollProducer0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7056 --caname ca.producer0.com --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7056-ca-producer0-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7056-ca-producer0-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/orderers/msp" --csr.hosts orderer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/peers/msp" --csr.hosts peer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.producer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/users/User@producer0.com/msp" --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://producer0admin:producer0adminpw@localhost:7056 --caname ca.producer0.com -M "${PWD}/organizations/producer0.com/users/Admin@producer0.com/msp" --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7056 --tls.certfiles "${PWD}/organizations/producer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollManufacturer0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7057 --caname ca.manufacturer0.com --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7057-ca-manufacturer0-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7057-ca-manufacturer0-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/orderers/msp" --csr.hosts orderer.manufacturer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.manufacturer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/peers/msp" --csr.hosts peer.manufacturer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.manufacturer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/users/User@manufacturer0.com/msp" --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://manufacturer0admin:manufacturer0adminpw@localhost:7057 --caname ca.manufacturer0.com -M "${PWD}/organizations/manufacturer0.com/users/Admin@manufacturer0.com/msp" --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7057 --tls.certfiles "${PWD}/organizations/manufacturer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollDistributor0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7058 --caname ca.distributor0.com --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7058-ca-distributor0-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7058-ca-distributor0-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/orderers/msp" --csr.hosts orderer.distributor0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.distributor0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/peers/msp" --csr.hosts peer.distributor0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.distributor0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/users/User@distributor0.com/msp" --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://distributor0admin:distributor0adminpw@localhost:7058 --caname ca.distributor0.com -M "${PWD}/organizations/distributor0.com/users/Admin@distributor0.com/msp" --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7058 --tls.certfiles "${PWD}/organizations/distributor0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
...
function enrollRetailer0() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7059 --caname ca.retailer0.com --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7059-ca-retailer0-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-7059-ca-retailer0-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the orderer msp"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/orderers/msp" --csr.hosts orderer.retailer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/orderers/tls" --enrollment.profile tls --csr.hosts orderer.retailer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer msp"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/peers/msp" --csr.hosts peer.retailer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer:peerpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/peers/tls" --enrollment.profile tls --csr.hosts peer.retailer0.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user:userpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/users/User@retailer0.com/msp" --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://retailer0admin:retailer0adminpw@localhost:7059 --caname ca.retailer0.com -M "${PWD}/organizations/retailer0.com/users/Admin@retailer0.com/msp" --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client identity list -u https://localhost:7059 --tls.certfiles "${PWD}/organizations/retailer0.com/fabric-ca/ca-cert.pem"
  { set +x; } 2>/dev/null
}
